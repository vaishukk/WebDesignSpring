...
1)Script.js
Consists functionality of delete button, edit button, Checkbox, image toggle as well as both submit button and add new student button.
...
Consists style for table

4)style.css
Consists style for entire page